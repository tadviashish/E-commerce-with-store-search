...
if (isset($_GET['ordercart'])) {
    $cartid = $_GET['ordercart'];
    $sql = "SELECT * FROM cart WHERE cart_id = '$cartid'";
    $rows = mysqli_query($conn, $sql);
    $row = mysqli_fetch_array($rows);

    $cid2 =  $row['cust_id'];
    $_SESSION['cust_id'] = $cid2;
    // echo $search;
}
                ...
                <div class="result">
                    ...
                    <div class="storeinfo">
                        ...
                        <p>
                            ...
                            if ($row['discount'] <= 0 || $today > $discount_date) {
                                ...
                                if ($row['discount'] > 0) {
                                    ...
                                    echo "<span>&#8377 </span>" .$discount_price."  (1-Item)";
                                }
                            }
                            ?>
                        </p>
                        ...
                        <div class="action">
                            ...
                            Quantity : <input type="number" name="quantity" value="1" style="width: 60px;">
                            ...
                            <button type="submit" name="order" value="<?php echo $row['pid']; ?>" style="background: #f2f2f2; width:70px; color:black">Continue</button>
                            </form>
                        </div>
                    </div>
                </div>
