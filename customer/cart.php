        ...
        <div class="container2">
            ...
            foreach ($rows as $row) : ?>
                ...
                <div class="result">
                    ...
                    <!-- <img src="../seller/uploads/ alt="Store" height="100px" width="100px"> -->
                    <div class="storeinfo">
                        <li><strong><a href="productdetails.php?product=<?php echo $row['product_id']; ?>"><?php echo $row['product_name'] ?></a></strong></li>
                        <p><?php echo $row['product_desc'] ?></p>
                        <p><?php echo "<span>&#8377 </span>".$row['product_price'] ?></p>
                    </div>
                        <div class="action">
                            <form action="cancel.php" method="get">
                                <!-- <button><a href="cart.php?cart=">Add to Cart</a></button> -->
                                <button type="submit" name="cancel" value="<?php echo $row['cart_id']; ?>" style="background: #f2f2f2; width:90px; color:black">REMOVE</button>
                            </form>
                                <form action="orderfromcart.php" method="get">
                                    <button type="submit" name="ordercart" value="<?php echo $row['cart_id']; ?>" style="background: #f2f2f2; width:90px; color:black">BUY</button>
                                </form>
