...
if (isset($_GET['deletedata'])) {
    ...
    header('refresh:1;url=seller_information.php');
}
...
<body>
    ...
    <div class="data">
        ...
        <div class="content">
            ...
            <form action="seller_information.php" method="get">
                <div class="button">
                ...
                $data = mysqli_query($conn, "SELECT * FROM seller_data LIMIT " . $startFrom . ',' . $limit);
