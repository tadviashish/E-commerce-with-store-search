    ...
    <div class="data">
        ...
        <div class="content">
            ...
            <form action="customer_info.php" method="get">
                ...
                $data = mysqli_query($conn, "SELECT * FROM cust_data WHERE CONCAT(cust_id,cust_name,cust_mobile,cust_state,cust_dist,cust_city,cust_pincode) LIKE '%$search%' LIMIT " . $startFrom . ',' . $limit);
